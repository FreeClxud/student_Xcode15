...
print("I expect the result of integer division of 10 divided by 3 to be 3.")
...
print("Result: \(divisionResult), Integer division: \(10 / 3)")
/*:
...
print("Remainder of \(even) divided by 2 is \(evenRemainder).")
print("Remainder of \(odd) divided by 2 is \(oddRemainder).")
