...
print("The average heart rate over the last hour is \(averageHR) beats per minute.")
...
print("The average heart rate over the last hour for the new constants is \(averageHRD) beats per minute.")

if averageHR == averageHRD {
    print("The averages are the same.")
}
...
print("You have achieved \(percentOfGoal)% of your goal.")
