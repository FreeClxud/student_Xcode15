...
progressUpdate(5, goal: 50)
progressUpdate(20, goal: 50)
progressUpdate(30, goal: 50)
progressUpdate(45, goal: 50)
progressUpdate(50, goal: 50)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    let expectedTime = pace * totalDistance
...
pacing(currentDistance: 5.0, totalDistance: 10.0, currentTime: 35.0, goalTime: 60.0)
