...
let user = User(userName: "Chris", email: "chris@example.com", age: 30)
...
let user1 = User(userName: "Chris", email: "chris@example.com", age: 30)
User.currentUser = user1

let user2 = User(userName: "Alex", email: "alex@example.com", age: 25)
